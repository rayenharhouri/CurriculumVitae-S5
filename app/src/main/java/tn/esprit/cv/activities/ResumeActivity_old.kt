...
class ResumeActivity_old : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameTv=findViewById(R.id.tv_name); ageTv=findViewById(R.id.tv_age); emailTv=findViewById(R.id.tv_email); genderTv=findViewById(
            R.id.tv_gender
        )
        androidTv=findViewById(R.id.tv_android); iosTv=findViewById(R.id.tv_ios); flutterTv=findViewById(
            R.id.tv_flutter
        )
